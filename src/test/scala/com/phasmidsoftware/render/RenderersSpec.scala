...
class RenderersSpec extends AnyFlatSpec with should.Matchers {
  ...
  it should "renderer0" in {
    ...
    rendererMyJunk.render(MyJunk, FormatText(0), None) shouldBe "{MyJunk}"
  }
  ...
  it should "renderer1" in {
    ...
    MyRenderers.rendererGreeting.render(Greeting("Hello"), FormatText(1), None) shouldBe "{Hello}"
  }
  ...
  it should "renderer2A" in {
    ...
    ComplexRenderers.rendererComplex.render(Complex(1, -1), FormatText(0), None) shouldBe """{r="1.0", i="-1.0"}"""
  }
  ...
  it should "renderer2B" in {
    ...
    KVRenderers.rendererKV.render(KV("a", -1), FormatText(0), None) shouldBe """{k="a", v="-1"}"""
  }
  ...
  it should "renderer4" in {
    ...
    KVVVRenderers.rendererKVVV.render(KVVV("a", -1, _b = false, math.Pi), FormatText(0), None) shouldBe """{k="a", v="-1", b="false", x="3.141592653589793"}"""
  }
  ...
  it should "sequenceRenderer" in {
    ...
    import MyRenderers._
    rendererIntSeq.render(Seq(42, 99, 1), FormatText(0), None) shouldBe
      """[42
        |99
        |1
        |]""".stripMargin
  ...
  it should "renderer5" in {
    ...
    KVVVRenderers.rendererKVVV.render(KVVVV("a", -1, _b = false, math.Pi, 42L), FormatText(0), None) shouldBe """{k="a", v="-1", b="false", x="3.141592653589793", l="42"}"""
  }
  ...
  it should "optionRenderer" in {
    ...
    import MyRenderers._
    rendererIntOption.render(Some(42), FormatText(0), None) shouldBe "42"
  }
  ...
  it should "renderer3" in {
    ...
    KVVRenderers.rendererKVV.render(KVV("a", -1, _b = false), FormatText(0), None) shouldBe """{k="a", v="-1", b="false"}"""
  }
  ...
  it should "renderer1" in {
    ...
    MyRenderers.rendererGreeting.render(Greeting("Hello"), FormatXML(0), None) shouldBe "<Greeting>Hello</Greeting>"
  }
  ...
  it should "renderer1A" in {
    ...
    MyRenderers.renderer.render(Scale(math.Pi), FormatXML(0), None) shouldBe "<Scale>3.141592653589793</Scale>"
  }
  ...
  it should "renderer0" in {
    ...
    import MyRenderers._
    rendererMyJunk.render(MyJunk, FormatXML(0), None) shouldBe "<MyJunk$>MyJunk</MyJunk$>"
  }
  ...
  it should "renderer2A" in {
    ...
    ComplexRenderers.rendererComplex.render(Complex(1, -1), FormatXML(0), None) shouldBe "<Complex>r=\"1.0\" i=\"-1.0\"</Complex>"
  }
  ...
  it should "renderer2B" in {
    ...
    KVRenderers.rendererKV.render(KV("a", -1), FormatXML(0), None) shouldBe """<KV>k="a" v="-1"</KV>"""
  }
  ...
  it should "renderer4" in {
    ...
    KVVVRenderers.rendererKVVV.render(KVVV("a", -1, _b = false, math.Pi), FormatXML(0), None) shouldBe """<KVVV>k="a" v="-1" b="false" x="3.141592653589793"</KVVV>"""
  }
  ...
  it should "sequenceRenderer" in {
    ...
    import MyRenderers._
    rendererIntSeq.render(Seq(42, 99, 1), FormatXML(0), None) shouldBe
      """
        |42
        |99
        |1
  ...
  it should "renderer5" in {
    ...
    KVVVRenderers.rendererKVVV.render(KVVVV("a", -1, _b = false, math.Pi, 42L), FormatXML(0), None) shouldBe """<KVVVV>k="a" v="-1" b="false" x="3.141592653589793" l="42"</KVVVV>"""
  }
  ...
  it should "optionRenderer" in {
    ...
    import MyRenderers._
    rendererIntOption.render(Some(42), FormatXML(0), None) shouldBe "42"
  }
