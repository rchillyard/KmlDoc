...
class RenderersSpec extends AnyFlatSpec with should.Matchers {
  ...
  it should "intRenderer" in {
    new Renderers {}.intRenderer.render(1, 0) shouldBe "1"
  }

  it should "stringRenderer" in {
    new Renderers {}.stringRenderer.render("Hello", 0) shouldBe "Hello"
  }

  it should "booleanRenderer" in {
    new Renderers {}.booleanRenderer.render(true, 0) shouldBe "true"
  }
  ...
  it should "doubleRenderer" in {
    new Renderers {}.doubleRenderer.render(math.Pi, 0) shouldBe "3.141592653589793"
  }
  ...
  it should "optionRenderer" in {
    ...
    import MyRenderers._
    rendererIntOption.render(Some(42), 0) shouldBe "42"
  }

  it should "longRenderer" in {
    new Renderers {}.longRenderer.render(42L, 0) shouldBe "42"
  }
